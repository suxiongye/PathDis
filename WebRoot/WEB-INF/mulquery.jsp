...
<%
	...
	String path_name = (String) request.getAttribute("path_source_name");
...
<script type="text/javascript">
						...
						$("#querypath1")
								.change(
										function(event) {
											...
											var l = $("#querypath1").val().length
													- $("#querypath1")[0].files[0].name.length;
											var filepath = $("#querypath1")
													.val().substring(0, l);
											$("#query_path1").val(filepath);
											for (var i = 0; i < $("#querypath1")[0].files.length; i++) {
	...
	jQuery(document).ready(function($) {
		$('#upload').click(function() {
			var type = $("#type").val();
			document.uploadForm.action = "mulquery?is_time=" + type;
				...
				<div class="navigation">
					...
					<ul class="navig">
						...
						<li><a href="<%=basePath%>query"
							class="hvr-bounce-to-bottom">相似轨迹查询</a></li>
							<li><a href="<%=basePath%>mulquery"
							class="active hvr-bounce-to-bottom">多轨迹查询</a></li>
						...
						<div class="bnr-one">
							...
							<div class="bnr-right" style="position:relative;">
								<input class="date" type="text" id="query_path1" /> <input
									class="date" type="file" name="file1" multiple="multiple"
									id="querypath1" value="" style="display:none" /> <input
									class="date" type="file" name="files" multiple="multiple"
									id="querypath2" value="" style="display:none" />
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="bnr-one">
		...
		<div class="">
			...
			<div id="resultdiv">
				<table class="bordered" id="data-table">
					...
					<%
						if (resultList != null) {
							Entry<String, Double> entry = resultList.get(0);
					%>
					<tr>
						<td><%=1%></td>
						<td><%=path_name%></td>
